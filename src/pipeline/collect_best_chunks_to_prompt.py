...
def find_best_chunk_to_prompt(vector_db, themes, k=10, fetch_k=40, lambda_mult=0.5, chunks_len=3):
    full_chunks_themes = []
    ...
    for query in themes:
        retriever = vector_db.as_retriever(
            ...
            search_kwargs={"k": k, "filter": {"theme": query}} # "filter": {"theme": "napoléon, france, pouvoir" #query REMETTRE
        ...
        relevant_docs = retriever.invoke(query) #query REMETTRE
        print(query)
